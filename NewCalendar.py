...
class CalendarDayItem(QObject, QGraphicsRectItem):
    ...
    def paint(self, painter, option, widget=None):
        ...
        if self._selected:                              # 选中
            ...
            painter.setBrush(QColor("#ffffff") if self.is_current_month else QColor("#f0f0f0"))
        ...
        if event_count > max_events_to_show:
            ...
            r = QRectF(event_area_rect.left(), event_area_rect.top() + max_events_to_show * line_h, event_area_rect.width(), line_h)
...
class CalendarView(QWidget):
    ...
    def draw_month(self, year, month, day_width=None, day_height=None):
        ...
        while current < end_date.addDays(1):
            rect = QRectF(col * day_width, row * day_height + weekday_height, day_width, day_height)
